...
export function MainMenu() {
  ...
  return (
    <div className="relative flex min-h-full flex-col items-center justify-center overflow-y-auto px-4 pb-6 pt-20 bg-gradient-to-br from-indigo-950 via-purple-900 to-pink-950">
